...
int main() {
    ...
    cout << "Opcion 1: Ver casos de prueba" << endl;
    cout << "Opcion 2: Ingresar lista" << endl;
    cin >> opcion;
    ...
    if(opcion == 1){
      ...
      cout << "Lista sin ordenar: " << endl;
      for(int i = 0; i < longitud3; i++){ //Tomamos los valores de la lista y los imprimimos para que los vea el usuario
         cout << lista3[i] << ", ";
      }
      cout << '\n';
      bucketSort(lista3, longitud3); //Con la funcion ordenamos la lista
